...
dummy_plastic<- data.frame(outer(rep(month.abb,length = 60), month.abb,"==") + 0 )
View(dummy_plastic)

colnames(dummy_plastic)<-month.abb # Assigning month names 
View(dummy_plastic)

Plasticsdata<-cbind(plastic,dummy_plastic)
